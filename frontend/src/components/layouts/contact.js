  ...
  return (
    <div className="contact">
      ...
      <div className="infobox">
        <h4 className="name">Aditi Baral</h4>
        <h6 className="email">(aditibaral0819@gmail.com)</h6>
      </div>
      <div className="infobox">
        <h4 className="name">Salina Koirala</h4>
        <h6 className="email">(saleena.koirala1@gmail.com)</h6>
      </div>
      <div className="infobox">
      ...
      <div className="infobox">
        <h4 className="name">Prasanna Mani Paudel</h4>
