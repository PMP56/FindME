...
class UserData(models.Model):
    ...
    userHeader = models.CharField(
        max_length=100, default='Welcome to my portfolio.')
    ...
    shadowText = models.CharField(
        max_length=100, default='I am a student/ professional/ designer/ ..................')
    firstIntro = models.CharField(
        max_length=125, default='## Short Introduction about me ##')
    secondIntro = models.CharField(
        max_length=250, default='Know about my skills, interest and projects here.')
    skills = ArrayField(
